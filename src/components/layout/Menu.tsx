...
const Menu: React.FC<MenuProps> = ({ isOpen, onClose, onLogout, showBottomNavbar = false }) => {
  ...
  const MenuItem = ({ 
    ...
    >
      <div className="flex-shrink-0 w-5 h-5 text-white/70 group-hover:text-white transition-colors">
        {icon}
      </div>
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="text-center py-8 px-6 border-b border-white/20">
        ...
        <PrimaryButton 
          text="Logout"
          onClick={onLogout}
          className="w-[50%] ml-[24%] bg-red-500/20 hover:bg-red-500/30 text-red-300 hover:text-white border-red-500/30"
        />
      </div>
      ...
      case 'nocenix':
        return (
          <div className="p-6">
            ...
            <p className="text-white/70 text-base leading-relaxed">Token balance and history page will be implemented here...</p>
          </div>
        );
      case 'verification':
        return (
          <div className="p-6">
            ...
            <p className="text-white/70 text-base leading-relaxed">Account verification page will be implemented here...</p>
          </div>
        );
      case 'settings':
        return (

      ...
      <div className="relative z-10 p-6 min-h-screen backdrop-blur-[0.5px]">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex justify-center mb-6">
            <div className="relative">
              <div 
                ...
                style={{ 
                  background: 'radial-gradient(circle at center, rgba(255,105,180,0.15) 0%, rgba(59,130,246,0.15) 40%, rgba(16,7,40,0.8) 100%)',
                  boxShadow: `
              ...
              <div className="absolute inset-0 overflow-hidden rounded-3xl pointer-events-none">
                <div className="absolute w-1 h-1 bg-nocenaPink rounded-full animate-ping" 
                     style={{ top: '20%', left: '15%', animationDelay: '0s' }}></div>
                <div className="absolute w-1 h-1 bg-nocenaBlue rounded-full animate-ping" 
                     style={{ top: '70%', right: '20%', animationDelay: '1s' }}></div>
                <div className="absolute w-0.5 h-0.5 bg-white/50 rounded-full animate-ping" 
                     style={{ top: '40%', right: '10%', animationDelay: '2s' }}></div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 mb-8 border border-white/20">
            ...
            <p className="text-white/50 text-sm">
              Beta tokens • No monetary value yet
            </p>
          </div>
        </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-orange-300/80 text-sm leading-relaxed">
                Nocenix is currently a <strong>testnet token</strong> with no monetary value. 
                These tokens are for testing purposes during our beta phase, but will carry over when we launch!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 mb-6 border border-white/20">
          ...
          <p className="text-white/80 leading-relaxed">
            ...
            Think of it as your digital reputation score that will have real value after our beta launch.
          </p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 mb-6 border border-white/20">
          ...
          <div className="space-y-4">
            {[
              {
                icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-nocenaBlue">
              ...
              <div key={index} className="flex items-center space-x-4 p-3 rounded-xl hover:bg-white/10 backdrop-blur-sm transition-colors">
                <div className={`w-12 h-12 ${item.bgColor} rounded-xl flex items-center justify-center backdrop-blur-sm`}>
                  {item.icon}
                </div>

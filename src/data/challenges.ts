...
export const dailyChallenges: Challenge[] = [
  ...
  },
  {
    ...
    description:
      'Compliment a stranger in a crowded place on something odd (e.g., "Your shoes remind me of a sunset").',
    category: ChallengeCategory.AI,
    frequency: ChallengeFrequency.DAILY,
  },
  {
  ...
  // Physical Challenges
  {
    title: 'Urban Gym',
    description:
      'Use your city as a gym and do as many different exercises as possible (e.g., bench dips, stair sprints, playground pull-ups).',
    category: ChallengeCategory.AI,
    frequency: ChallengeFrequency.DAILY,
  },
  {

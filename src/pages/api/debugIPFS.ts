...
function getRecommendations(
  ...
  if (!directoryExists) {
    recommendations.push('The IPFS directory does not appear to exist. The CID may be incorrect or the content may not be properly pinned.');
    ...
    recommendations.push('The directory exists but the specific file could not be accessed. Check if the filename is correct.');
  }

...
const FileUploadView: React.FC<FileUploadViewProps> = ({ 
  ...
  const handleSubmit = () => {
    ...
    if (durationValid !== true) {
      setError(`Video duration must be between ${formatDuration(minDuration, true)} and ${formatDuration(maxDuration, true)}`);
      return;
    }
      ...
      <div className="bg-[#1A2734] rounded-xl p-6 w-full mb-6">
        ...
        <div className="mb-8">
          ...
          {videoPreview ? (
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-400 mb-2">

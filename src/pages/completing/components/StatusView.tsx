...
const StatusView: React.FC<StatusViewProps> = ({ state, statusMessage, error, reward, onRetry }) => {
  switch (state) {
    case RecordingState.UPLOADING:
      return (
        <div className="w-full flex flex-col items-center justify-center py-8">
          ...
          <p className="text-center text-white text-xl mb-2">{statusMessage || 'Processing your challenge...'}</p>
    ...
    case RecordingState.COMPLETE:
      return (
        <div className="w-full flex flex-col items-center justify-center py-8">
          ...
          <p className="text-center text-white text-xl mb-2">Challenge Completed!</p>
          ...
          <p className="text-center text-gray-300">Redirecting to home...</p>
        </div>
      );
    ...
    case RecordingState.ERROR:
      return (
        <div className="w-full flex flex-col items-center justify-center py-8">
          ...
          <p className="text-center text-white text-xl mb-4">Something went wrong</p>
          <p className="text-center text-gray-400 mb-6">
            {error || 'We encountered an error while processing your challenge.'}
          </p>
          <PrimaryButton text="Try Again" onClick={onRetry} isActive={true} />
        </div>
      );
